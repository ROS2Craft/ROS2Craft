package net.gitsrealpe.roscraft.block;
...
import net.gitsrealpe.roscraft.block.custom.ROS2LinkBlock;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(ROScraft.MODID);
